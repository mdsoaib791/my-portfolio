      ...
      <div className="container relative justify-center flex">
        <div className="grid grid-cols-3 md:gap-8 lg:gap-x-20 items-center">
          <div className="col-span-2">
            ...
            <p>It&apos;s a great day to learn React!</p>
            <p>Don&apos;t forget to check out the documentation.</p>
            <p>Here&apos;s an example of a component.</p>
            <p>React&apos;s flexibility is unmatched.</p>
            <p>Use &quot;props&quot; to pass data to components.</p>
            <p>React&apos;s &quot;state&quot; is powerful for dynamic UIs.</p>
          </div>
